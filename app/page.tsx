  ...
  return (
    <div style={{ position: "relative", width: "100vw", height: "100vh", overflow: "hidden", background: "#080e1f" }}>
      ...
      <div style={{
        ...
        transition: "width 0.5s ease", boxShadow: "0 0 12px rgba(201,162,39,0.7)"
      }} />
      ...
      <div style={{
        ...
        background: "rgba(8,14,31,0.8)", backdropFilter: "blur(20px)",
        border: "1px solid rgba(201,162,39,0.15)", borderRadius: "100px",
        padding: "0.6rem 1.25rem", zIndex: 100,
      }}>
          ...
          {slides.map((s, i) => (
            <div
              ...
              style={{
                ...
                borderRadius: 3,
                background: i === current ? "#c9a227" : "rgba(255,255,255,0.15)",
        ...
        <span style={{ color: "rgba(255,255,255,0.3)", fontSize: "0.72rem", minWidth: 40, textAlign: "center" }}>
          {current + 1}/{total}
        </span>
      </div>
      ...
      <div style={{
        ...
        color: "rgba(255,255,255,0.18)", fontSize: "0.65rem", letterSpacing: "0.1em",
        display: "flex", gap: "6px", alignItems: "center", zIndex: 99
      }}>
...
function Kbd({ children }: { children: React.ReactNode }) {
  return (
    <span style={{
      ...
      border: "1px solid rgba(255,255,255,0.1)", borderRadius: 3, fontSize: "0.62rem"
    }}>{children}</span>
  );
}
...
function SlideShell({ children, header }: { children: React.ReactNode; header?: string }) {
  return (
    <div style={{
      ...
      <div style={{
        position: "absolute", inset: 0,
        background: "radial-gradient(ellipse 80% 50% at 50% 0%, rgba(45,77,184,0.2) 0%, transparent 70%), radial-gradient(ellipse 50% 40% at 90% 90%, rgba(201,162,39,0.1) 0%, transparent 60%)"
      }} />
      ...
      {header && (
        <div style={{
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            ...
            <span style={{ color: "rgba(255,255,255,0.6)", fontSize: "0.8rem", fontWeight: 500, letterSpacing: "0.04em" }}>
              PannonGuard Komplex
            </span>
          </div>
          <span style={{ color: "rgba(201,162,39,0.55)", fontSize: "0.7rem", letterSpacing: "0.18em", textTransform: "uppercase" }}>
            {header}
          </span>
        </div>
      )}
  ...
  return (
    <SlideShell>
      ...
      <div style={{ textAlign: "center", display: "flex", flexDirection: "column", alignItems: "center" }}>
        ...
        {/* Divider */}
        <div style={{ width: 280, height: 1, background: "linear-gradient(90deg, transparent, rgba(201,162,39,0.5), transparent)", margin: "1.75rem auto", animation: "fadeIn 1s ease 0.9s both" }} />

        <p style={{ color: "rgba(255,255,255,0.3)", fontSize: "0.85rem", letterSpacing: "0.12em", animation: "fadeUp 0.8s ease 1s both" }}>
...
function VisionSlide() {
  ...
  return (
    <SlideShell>
      <div style={{ textAlign: "center", maxWidth: 1100, width: "90%", paddingTop: "2rem" }}>
        <div style={{ color: "rgba(201,162,39,0.7)", fontSize: "0.7rem", letterSpacing: "0.25em", textTransform: "uppercase", marginBottom: "1rem", animation: "fadeUp 0.6s ease 0.1s both" }}>
          Rendszer áttekintő
        </div>
        <h2 style={{
          fontFamily: "'Playfair Display', serif",
        ...
        <p style={{ color: "rgba(255,255,255,0.35)", fontSize: "0.95rem", lineHeight: 1.8, marginBottom: "3rem", animation: "fadeUp 0.6s ease 0.3s both" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "1.25rem" }}>
          {pillars.map((p, i) => (
            ...
            >
              <div style={{ fontSize: "1.4rem", color: "rgba(201,162,39,0.7)", marginBottom: "0.75rem" }}>{p.icon}</div>
              <div style={{ color: "#fff", fontWeight: 600, fontSize: "0.95rem", marginBottom: "0.4rem" }}>{p.label}</div>
              <div style={{ color: "rgba(255,255,255,0.4)", fontSize: "0.82rem", lineHeight: 1.65 }}>{p.desc}</div>
            </div>
          ))}
        </div>
      </div>
  ...
  return (
    <SlideShell header="Személyes előnyök">
      <div style={{
        ...
        gap: "4rem", maxWidth: 1140, width: "90%",
        alignItems: "start", paddingTop: "4.5rem",
      }}>
        {/* LEFT */}
        <div style={{ animation: "fadeUp 0.6s ease 0.1s both" }}>
          {/* Slide counter */}
          <div style={{ color: "rgba(201,162,39,0.4)", fontSize: "0.65rem", letterSpacing: "0.25em", textTransform: "uppercase", marginBottom: "1.5rem" }}>
            {slideNum} — {total}
          </div>
          ...
          <div style={{
            ...
            boxShadow: "0 0 40px rgba(45,77,184,0.2), inset 0 0 20px rgba(201,162,39,0.05)",
          }}>
            <span style={{ opacity: 0.6, fontSize: "1.6rem" }}>✦</span>
          </div>
          ...
          <p style={{ color: "rgba(255,255,255,0.3)", fontSize: "0.82rem", lineHeight: 1.8 }}>
            A <strong style={{ color: "rgba(255,255,255,0.55)", fontWeight: 500 }}>PannonGuard Komplex</strong> az alábbi területeken nyújt közvetlen segítséget:
          </p>
        </div>
        ...
        <div style={{
          ...
          {slide.benefits.map((b, i) => (
            <div
              ...
              onMouseEnter={e => {
                ...
                (e.currentTarget as HTMLElement).style.borderLeftColor = "rgba(201,162,39,0.7)";
                (e.currentTarget as HTMLElement).style.transform = "translateX(3px)";
              }}
              onMouseLeave={e => {
                (e.currentTarget as HTMLElement).style.background = "rgba(255,255,255,0.025)";
                (e.currentTarget as HTMLElement).style.borderLeftColor = "rgba(201,162,39,0.35)";
                (e.currentTarget as HTMLElement).style.transform = "translateX(0)";
              }}
            >
              <span style={{ color: "rgba(201,162,39,0.5)", fontSize: "0.7rem", marginTop: 3, flexShrink: 0, fontFamily: "monospace" }}>
                {String(i + 1).padStart(2, "0")}
              </span>
              <span style={{ color: "rgba(255,255,255,0.7)", fontSize: "0.87rem", lineHeight: 1.65 }}>
                {b}
              </span>
            </div>
          ))}
          ...
          <div
            style={{
              ...
              borderRadius: "0 12px 12px 0",
              borderLeft: "2px dashed rgba(201,162,39,0.25)",
          ...
          >
            ...
            <span style={{
              color: "rgba(201,162,39,0.5)", fontSize: "0.82rem",
...
function CompanySlide() {
  ...
  return (
    <SlideShell header="Vállalati szintű hatás">
      <div style={{ maxWidth: 1100, width: "90%", paddingTop: "5rem", textAlign: "center" }}>
        <div style={{ color: "rgba(201,162,39,0.6)", fontSize: "0.7rem", letterSpacing: "0.25em", textTransform: "uppercase", marginBottom: "0.75rem", animation: "fadeUp 0.6s ease 0.1s both" }}>
        ...
        <p style={{ color: "rgba(255,255,255,0.3)", fontSize: "0.88rem", marginBottom: "2.5rem", animation: "fadeUp 0.6s ease 0.3s both" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: "1rem", marginBottom: "2.5rem", animation: "fadeUp 0.6s ease 0.35s both" }}>
          {items.map((item, i) => (
            <div key={i} style={{
              background: "rgba(255,255,255,0.025)", border: "1px solid rgba(201,162,39,0.12)",
              ...
              <div style={{ color: "rgba(255,255,255,0.35)", fontSize: "0.77rem", lineHeight: 1.5 }}>{item.desc}</div>
            </div>
          ))}
        </div>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(5, 1fr)", gap: "0.65rem", animation: "fadeUp 0.6s ease 0.45s both" }}>
          {depts.map((name, i) => (
            <div key={i} style={{
              ...
              color: "rgba(255,255,255,0.55)", fontSize: "0.75rem", fontWeight: 500,
              display: "flex", alignItems: "center", gap: "0.5rem",
            }}>
              <span style={{ color: "rgba(201,162,39,0.4)", fontSize: "0.6rem" }}>✦</span>
              {name}
            </div>
          ))}
        </div>
  ...
  return (
    <SlideShell>
      ...
      <div style={{ textAlign: "center", display: "flex", flexDirection: "column", alignItems: "center", gap: "0.75rem" }}>
        ...
        <div style={{ color: "rgba(201,162,39,0.55)", fontSize: "0.7rem", letterSpacing: "0.3em", textTransform: "uppercase", animation: "fadeUp 0.7s ease 0.2s both" }}>
        ...
        <p style={{ color: "rgba(255,255,255,0.35)", fontSize: "clamp(0.88rem, 1.5vw, 1rem)", maxWidth: 520, lineHeight: 1.85, animation: "fadeUp 0.7s ease 0.5s both" }}>
        ...
        <div style={{ display: "flex", gap: "3rem", marginTop: "2rem", animation: "fadeUp 0.7s ease 0.65s both" }}>
          {[["10+", "Részleg"], ["∞", "Lehetőség"], ["1", "Rendszer"]].map(([num, label], i) => (
            <div key={i} style={{ textAlign: "center" }}>
              ...
              <div style={{ color: "rgba(255,255,255,0.3)", fontSize: "0.72rem", letterSpacing: "0.12em", textTransform: "uppercase" }}>{label}</div>
            </div>
          ))}
        </div>

        <div style={{ width: 160, height: 1, background: "linear-gradient(90deg, transparent, rgba(201,162,39,0.35), transparent)", marginTop: "2rem", animation: "fadeIn 1s ease 0.9s both" }} />
        <div style={{ color: "rgba(255,255,255,0.15)", fontSize: "0.7rem", letterSpacing: "0.2em", textTransform: "uppercase", animation: "fadeUp 0.7s ease 1s both" }}>
          PannonGuard · 2024
        </div>
      </div>
    </SlideShell>
...
function ArchitectureSlide() {
  ...
  return (
    <SlideShell header="Rendszerarchitektúra">
      <div style={{ width: "90%", maxWidth: 1150, paddingTop: "4.5rem" }}>

        {/* Title */}
        <div style={{ textAlign: "center", marginBottom: "2.5rem", animation: "fadeUp 0.6s ease 0.1s both" }}>
          <div style={{ color: "rgba(201,162,39,0.6)", fontSize: "0.7rem", letterSpacing: "0.25em", textTransform: "uppercase", marginBottom: "0.6rem" }}>
            Rendszerarchitektúra
          </div>
          <h2 style={{ fontFamily: "'Playfair Display', serif", fontSize: "clamp(1.8rem, 3.5vw, 2.8rem)", fontWeight: 700, color: "#fff", lineHeight: 1.1 }}>
            Moduláris felépítés &{" "}
            <span style={{ background: "linear-gradient(135deg,#f0c940,#c9a227)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", backgroundClip: "text" }}>
              központi irányítás
            </span>
        ...
        <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 0 }}>
          ...
          <div style={{ animation: "fadeUp 0.6s ease 0.2s both", width: "100%" }}>
            <div style={{
              ...
              <div style={{ display: "flex", alignItems: "center", gap: "0.75rem", justifyContent: "center" }}>
                ...
                <span style={{ color: "#fff", fontWeight: 700, fontSize: "1rem", letterSpacing: "0.03em" }}>
                  PannonGuard CRM
                </span>
                <span style={{ color: "#fff", fontWeight: 700, fontSize: "1rem" }}>—</span>
                <span style={{ color: "rgba(255,255,255,0.75)", fontWeight: 500, fontSize: "0.9rem" }}>
              ...
              <div style={{
                ...
                fontSize: "0.62rem", fontWeight: 700, color: "#080e1f", letterSpacing: "0.1em",
              }}>
                ISO COMPLIANT
              </div>
            </div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: "1rem", width: "100%", animation: "fadeUp 0.6s ease 0.4s both" }}>
            {[
              ...
              <div key={i} style={{
                ...
                <div style={{ fontSize: "1.2rem", color: "rgba(201,162,39,0.6)", marginBottom: "0.5rem" }}>{item.icon}</div>
                <div style={{ color: "#fff", fontWeight: 600, fontSize: "0.85rem", marginBottom: "0.3rem" }}>{item.label}</div>
                <div style={{ color: "rgba(255,255,255,0.38)", fontSize: "0.76rem", lineHeight: 1.55 }}>{item.desc}</div>
              </div>
            ))}
          </div>
          ...
          <div style={{ width: "100%", animation: "fadeUp 0.6s ease 0.6s both" }}>
            {/* Label */}
            <div style={{ textAlign: "center", color: "rgba(255,255,255,0.25)", fontSize: "0.68rem", letterSpacing: "0.18em", textTransform: "uppercase", marginBottom: "0.75rem" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(5, 1fr)", gap: "0.55rem" }}>
              {departments.map((dept, i) => (
                <div key={i} style={{
                  ...
                  <span style={{ color: "rgba(201,162,39,0.5)", fontSize: "0.62rem" }}>✦</span>
                  <span style={{ color: "rgba(255,255,255,0.65)", fontSize: "0.73rem", fontWeight: 500, lineHeight: 1.3 }}>{dept}</span>
...
function Arrow() {
  return (
    <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 0, margin: "6px 0" }}>
      <div style={{ width: 1, height: 18, background: "rgba(201,162,39,0.35)" }} />
      <div style={{ width: 0, height: 0, borderLeft: "5px solid transparent", borderRight: "5px solid transparent", borderTop: "7px solid rgba(201,162,39,0.5)" }} />
    </div>
  );
}
...
function MiniPill({ children, accent }: { children: React.ReactNode; accent?: boolean }) {
  return (
    <span style={{
      ...
      background: accent ? "rgba(201,162,39,0.15)" : "rgba(255,255,255,0.04)",
      border: accent ? "1px solid rgba(201,162,39,0.3)" : "1px solid rgba(255,255,255,0.06)",
      color: accent ? "rgba(201,162,39,0.9)" : "rgba(255,255,255,0.35)",
    ...
    <SlideShell header="MI Asszisztens">
      <div style={{ width: "90%", maxWidth: 1150, paddingTop: "4.5rem" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: "2.5rem", animation: "fadeUp 0.6s ease 0.1s both" }}>
          ...
          <p style={{ color: "rgba(255,255,255,0.35)", fontSize: "0.88rem", marginTop: "0.6rem", lineHeight: 1.7 }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "280px 1fr", gap: "2.5rem", alignItems: "start" }}>
          ...
          <div style={{ animation: "fadeUp 0.6s ease 0.2s both" }}>
            ...
            <div style={{
              ...
              <div style={{ position: "absolute", top: 0, left: 0, right: 0, height: 2, background: "linear-gradient(90deg, transparent, rgba(201,162,39,0.6), transparent)" }} />

              <div style={{ color: "rgba(255,255,255,0.35)", fontSize: "0.65rem", letterSpacing: "0.2em", textTransform: "uppercase", marginBottom: "0.75rem" }}>
                Osztály Modul
              </div>
              ...
              <div style={{
                ...
                <div style={{ color: "rgba(255,255,255,0.6)", fontSize: "0.78rem", fontWeight: 500, marginBottom: "0.3rem" }}>Napi munkafolyamatok</div>
                <div style={{ color: "rgba(255,255,255,0.25)", fontSize: "0.72rem", lineHeight: 1.5 }}>Dokumentumok · Nyilvántartás · Riportok · Naptár</div>
              </div>

              {/* Divider + arrow down */}
              <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 2, margin: "4px 0" }}>
                <div style={{ width: 1, height: 12, background: "rgba(201,162,39,0.4)" }} />
                <div style={{ width: 0, height: 0, borderLeft: "4px solid transparent", borderRight: "4px solid transparent", borderTop: "6px solid rgba(201,162,39,0.5)" }} />
              </div>
              ...
              <div style={{
                ...
                <div style={{ display: "flex", alignItems: "center", gap: "0.5rem", marginBottom: "0.4rem" }}>
                  ...
                  <span style={{ color: "rgba(201,162,39,0.95)", fontWeight: 700, fontSize: "0.82rem", letterSpacing: "0.05em" }}>MI Asszisztens</span>
                </div>
                <div style={{ color: "rgba(201,162,39,0.55)", fontSize: "0.72rem", lineHeight: 1.55 }}>
              ...
              <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 2, marginTop: "0.75rem" }}>
                <div style={{ height: 1, width: 40, background: "rgba(201,162,39,0.3)" }} />
                <div style={{ color: "rgba(201,162,39,0.5)", fontSize: "0.7rem" }}>→ képességek</div>
              </div>
            </div>
            ...
            <div style={{
              ...
              <div style={{ color: "rgba(150,180,255,0.8)", fontSize: "0.75rem", fontWeight: 600, marginBottom: "0.2rem" }}>◎ PannonGuard CRM</div>
              <div style={{ color: "rgba(150,180,255,0.45)", fontSize: "0.7rem", lineHeight: 1.5 }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "0.75rem" }}>
            {capabilities.map((cap, i) => (
              ...
              onMouseEnter={e => {
                (e.currentTarget as HTMLElement).style.background = "rgba(201,162,39,0.05)";
                (e.currentTarget as HTMLElement).style.borderLeftColor = "rgba(201,162,39,0.65)";
              }}
              onMouseLeave={e => {
                (e.currentTarget as HTMLElement).style.background = "rgba(255,255,255,0.025)";
                (e.currentTarget as HTMLElement).style.borderLeftColor = "rgba(201,162,39,0.3)";
              }}
              >
                <div style={{ display: "flex", alignItems: "center", gap: "0.5rem", marginBottom: "0.35rem" }}>
                  <span style={{ color: "rgba(201,162,39,0.6)", fontSize: "0.9rem" }}>{cap.icon}</span>
                  <span style={{ color: "#fff", fontWeight: 600, fontSize: "0.82rem" }}>{cap.title}</span>
                </div>
                <p style={{ color: "rgba(255,255,255,0.38)", fontSize: "0.76rem", lineHeight: 1.6, margin: 0 }}>{cap.desc}</p>
              </div>
            ))}
          </div>
        </div>
...
function SystemTextSlide() {
  ...
  return (
    <SlideShell header="Rendszer összefoglaló">
      <div style={{ width: "90%", maxWidth: 1000, paddingTop: "4.5rem" }}>
          ...
          {points.map((pt, i) => (
            <div key={i} style={{
              ...
              <div style={{
                ...
                <span style={{ fontFamily: "'Playfair Display', serif", fontSize: "1.1rem", fontWeight: 700, background: "linear-gradient(135deg,#f0c940,#c9a227)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", backgroundClip: "text" }}>
                  {pt.num}
                </span>
              </div>
              ...
              <div style={{
                ...
                <div style={{ color: "#fff", fontWeight: 600, fontSize: "0.92rem", marginBottom: "0.35rem" }}>{pt.title}</div>
                <div style={{ color: "rgba(255,255,255,0.45)", fontSize: "0.83rem", lineHeight: 1.7 }}>{pt.body}</div>
              </div>
            </div>
          ))}
        </div>
